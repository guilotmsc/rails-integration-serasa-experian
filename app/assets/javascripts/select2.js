        ...
        initContainer: function () {
            ...
            this.search.bind("keydown", this.bind(function (e) {
                ...
                if (this.opened()) {
                    ...
                    if (e.which === KEY.ENTER || KEY.isControl(e) || KEY.isFunctionKey(e) || e.which === KEY.ESC) {
                        return;
                    }
            ...
            selection.bind("keydown", this.bind(function(e) {
                ...
                if (e.which == KEY.DOWN || e.which == KEY.UP
                    || (e.which == KEY.SPACE && this.opts.openOnEnter)) {
                    this.open();
                    killEvent(e);
                    return;
                }
...
if (e.which == KEY.DELETE || e.which == KEY.BACKSPACE || e.which == KEY.ENTER || e.which == KEY.ENTER || e.which == 0) {
return
}
...
return container;
        ...
        initContainer: function () {
            ...
            this.search.bind("keydown", this.bind(function (e) {
                ...
                if (e.which === KEY.ENTER || KEY.isControl(e) || KEY.isFunctionKey(e)
